...
public class Match {
	...
	public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore,
			String bowlTeam, String bowlTeamScore, String liveText, String textComplete, String matchLink,
	...
	public String toString() {
		return "Match [matchId=" + matchId + ", teamHeading=" + teamHeading + ", matchNumberVenue=" + matchNumberVenue
				...
				+ ", bowlTeamScore=" + bowlTeamScore + ", liveText=" + liveText + ", textComplete=" + textComplete
				+ ", matchLink=" + matchLink + ", status=" + status + ", date=" + date + "]";
	}
